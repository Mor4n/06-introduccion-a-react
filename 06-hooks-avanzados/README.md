...
https://inquisitive-taiyaki-7e3ecb.netlify.app/

## Como conclusión personal:

En esta práctica pude aprender nuevos hooks ;w; estos se me hicieron bastantes complicados, pero en resumen, se hizo uso del useReducer para la lógica del contador y sus acciones, del useRef para controlar el focus sin renderizar de más y useCallback para evitar recrear funciones de forma innecesaria
